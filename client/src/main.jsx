...
// const ChatPage = React.lazy(() => import("./routes/chatPage/chatPage.jsx")); // <-- NEW IMPORT
...
//                   {/* FIX: Add the Chat Route here */}
//                   <Route path="/chat/:partnerUsername" element={<ChatPage />} />
...
const ExplorePage = React.lazy(() => import("./routes/explorePage/explorePage"));
const SimilarPinsPage = React.lazy(() => import("./routes/similarPinsPage/SimilarPinsPage"));
const ChatPage = React.lazy(() => import("./routes/chatPage/chatPage.jsx"));
const MessagesPage = React.lazy(() => import("./routes/messagesPage/MessagesPage.jsx"));
const NotificationsPage = React.lazy(() => import("./routes/notifications/NotificationsModal.jsx"));
